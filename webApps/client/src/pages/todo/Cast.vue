    ...
    <scroll ref="scroll" class="scroll-wrapper">
      <div>
        ...
        <div class="info-table-area">
          ...
          <table v-show="open" class="info-table" v-if="data.investmentTarget === 'Pre-ABS'">
            <tr>
          ...
          <!-- 0101 -->
          <table v-show="open" class="info-table" v-if="data.investmentTarget == 'ABS优先、夹层或劣后'">
            <tr>
          ...
          <!-- 0202 -->
          <table v-show="open" class="info-table" v-if="data.investmentTarget == '满足客户的具体需求'">
            <tr>

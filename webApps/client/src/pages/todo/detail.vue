<template>
  <div class="white-bg">
      ...
      <div>
        ...
        <div class="info-table-area">
          ...
          <div v-else class="mid-title">
            <span @click="showDetail" class="open-text">
              点击展开更多
              <img class="open-icon" :src="require('@/assets/images/icon_dropdown.png')">
            </span>
          </div>
          ...
          <table v-show="open" class="info-table">
            ...
            <tr v-show="data.requirements=='循环结构'">
              <td colspan="6">
                循环期【
                <span>{{data.cyclePeriod}}</span>】+ 摊还期【
                <span>{{data.amortizationPeriod}}</span> 】个月
              </td>
            </tr>
            <tr></tr>
            <tr v-show="data.channel=='理财通'">
              <td colspan="6">
                理财通分【
                <span>{{data.packageNum}}</span>】包发行，单包规模【
                <span>{{data.packageScale}}</span> 】万元
              </td>
            </tr>
            <!-- <tr>
              <th colspan="2" class="Leftlist">项目前端收入</th>
              <td colspan="2">{{data.frontIncome}}</td>
            </tr>
            <tr>
              <th colspan="2" class="Leftlist">项目后端收入</th>
              <td colspan="2">{{data.afterIncome}}</td>
            </tr>
            <tr>
              <th colspan="2" class="Leftlist">项目团队意见</th>
          ...
          <template v-if="open">
            <th
              class="th"
              style="width: 145px;color: #626262;background: #f9fafb;font-weight: normal;padding: 20px 0;border-right: 1px solid #eee;"
            >项目前端收入</th>
            <td
              style="width: 294px;color: #626262;font-weight: normal;padding: 20px 0;text-align: center;word-wrap: break-word;border: 1px solid rgba(151, 151, 151, 0.1);"
            >{{data.frontIncome}}</td>
            <br>
            <th
              class="th"
        ...
        <div v-show="open" class="progress-area">
          ...
          <div v-for="item in progressHistory" :key="item.$index" class="progress-item">
            ...
            <div class="progress-icon">
              <img :src="require('@/assets/images/icon_done.png')">
            </div>
            <div class="content">
    ...
    <div class="Loading" v-show="DisshowList">
